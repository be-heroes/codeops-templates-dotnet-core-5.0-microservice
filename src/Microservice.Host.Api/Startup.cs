...
namespace Microservice.Host.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Microservice.Host.Api v1"));
        ...
        protected virtual void AddHostServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Description = "Microservice is responsible for tracking capability AWS cloud expenses"
                });
            });
            ...
            services.AddAsyncApiSchemaGeneration(options =>
            {
                ...
                {
                    Info = new Info("Microservice.Host.Api", "1.0.0")
                    {
                        Contact = new Contact 
                        {
                            Name = "CloudEngineering",
                ...
                options.Middleware.UiTitle = "Microservice.Host.Api AsyncAPI Documentation";
            });
